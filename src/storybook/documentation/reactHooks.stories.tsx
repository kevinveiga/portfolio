...
if (state1) {
  return null;
            ...
            <ListDocs>
                <li>
                    <StrongDocs>Não use const</StrongDocs> em componentes, custom hooks, reducers, ou seja, arquivos do React com a extensão{' '}
                    <StrongDocs>.tsx</StrongDocs>, são declaradas como <StrongDocs>function</StrongDocs>, exceto nas funções de Data Fetching do
                    NextJS. Ex:
                </li>
            </ListDocs>
...
export function useApp(): IAppContext {...}`}
            ...
            <ListDocs>
                <li>
                    <StrongDocs>Use const</StrongDocs> em Styled Components e funções de JavaScript, ou seja, arquivos com a extensão{' '}
                    <StrongDocs>.ts</StrongDocs>. Ex:
                </li>
            </ListDocs>
...
export const maskPhone = (value: string): IMask => {...}`}
            ...
            <BoxDocs>
                Olhando os exemplos mais novos, <StrongDocs>componentes são declarados como function</StrongDocs> e <StrongDocs>não const</StrongDocs>
                . O motivo principal do React estar usando function ao invés de declarar uma const, é que uma function funciona fora de ordem na
                chamada, e uma const precisa estar declarado anteriormente ao uso do mesmo. Um componente não é uma constante, e sim, uma função. Faz
                sentido usar const para funções anônimas, mas o componente por si só não é uma função anônima, e sim, uma função bem definida.
            </BoxDocs>
...
export default yup;`}
            ...
            <ListDocs>
                ...
                <li>
                    Quando for usar a verificação de length no jsx, <StrongDocs>SEMPRE</StrongDocs> usar um operador de comparação. Ex:
            ...
            <ListDocs>
                ...
                <li>
                    Quando usar memo.{' '}
                    <a href="https://www.youtube.com/watch?v=sBA_SDhIPqQ&ab_channel=Rocketseat" rel="noopener noreferrer" target="_blank">
                        (vídeo)
                    </a>
                </li>
                ...
                <li>
                    ...
                    <a href="https://www.youtube.com/watch?v=jMWNNSx-mcU&ab_channel=Rocketseat" rel="noopener noreferrer" target="_blank">
                        (vídeo)
                    </a>
                </li>
                ...
                <li>
                    ...
                    <a href="https://www.youtube.com/watch?v=kCpca2z2cls&ab_channel=Rocketseat" rel="noopener noreferrer" target="_blank">
                        (vídeo)
                    </a>
                </li>
