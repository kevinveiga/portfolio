  ...
  return (
    <SvgStyled {...props} viewBox="0 0 12 16" xmlns="http://www.w3. org/2000/svg">
      <path d="M6 16s6-5.69 6-10A6 6 0 0 0 0 6c0 4.31 6 10 6  10zm0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6Z" />
            ...
            <P>
                Um erro no console dos navegadores aparece quando se usa o objeto de responsividade do Styled System na propriedade height ou width no
                componente de svg. Ex:
            </P>

            <Subtitle2Docs>{`height={{ d: '18px', md: '28px' }}`}</Subtitle2Docs>

            <P>Para evitar este tipo de erro deve-se colocar a propriedade height ou width no elemento pai ao invés do próprio componente de svg.</P>

            <Title2Docs>Otimização</Title2Docs>

            <ListDocs>
                <li>
                    Limpar código desnecessário, converter stroke para path, combinar paths quando possível, deixar com o fill em default, tirar
                    sobras da viewbox do svg, entre outras otimizações, tudo isso pode ser feito com o programa Inkscape{' '}
            ...
            <Subtitle2Docs>
                1. Na aba Edit, abrir a janela XML editor, para poder visualizar a estrutura do svg, e na aba Object abrir a janela Fill and Stroke,
                para poder visualizar os preenchimentos de Fill e Stroke.
                <br />
                ...
                <br />
                4. Com o svg todo selecionado vá na aba Path e use a opção Union. (Usar nos Paths que são da mesma cor se deseja manter Paths com
                cores diferentes. Caso ocorra algum problema com o svg, verifique se os Strokes foram convertidos para Paths).
                <br />
            ...
            <ListDocs>
                <li>
                    Depois das otimizações no Inkscape, colocar o arquivo no site SvgOmg <a href="https://jakearchibald.github.io/svgomg/">(link)</a>,
                    e use as seguintes configurações:
                </li>
            </ListDocs>
