...
function FetchAxiosWithHooks(): ReactElement {
    return (
        <>
            ...
            <ListDocs>
                <li>
                    O token da requisição é configurado no interceptor do Axios, mas é necessário passar o token também na função getFetch, por causa
                    do SWR que precisa do token em sua utilização.
                </li>
            </ListDocs>
