...
import { BoxDocs, ListDocs, SpacerDocs, StrongDocs, Subtitle1Docs, Subtitle2Docs, Title1Docs, Title2Docs } from '@/styles/storybook';
...
function GettingStartedWithHooks(): ReactElement {
    return (
        <>
            ...
            <P>
                Documentação Front-end para os projetos em React, com a finalidade de manter a padronização, organização, metodologias e boas práticas
                no desenvolvimento.
            </P>
...
"typescript.updateImportsOnFileMove.enabled": "always"`}
            ...
            <ListDocs>
                <li>
                    components:
                    <br />
                    <Subtitle2Docs>Componentes de uso em geral no projeto e componentes de estilo específicos desses componentes.</Subtitle2Docs>
                </li>
            ...
            <ListDocs>
                ...
                <li>
                    Coloque nomes de maneira que façam sentido nas variáveis, funções, componentes, etc, não utilize nomes como: shortDate2,
                    shortDate3. De preferência para seguir a mesma regra de outras coisas que já existem no projeto.
                </li>
            </ListDocs>
            ...
            <ListDocs>
                <li>
                    ...
                    <br />
                    <Subtitle2Docs>
                        O código deve ser pensado para atender pelo menos a responsividade básica, a principal forma de fazer isso é utilizando o
                        Flex, para ajustes finos pode ser usado a responsividade na propriedade do componente de estilo ou dentro do estilo.
                    </Subtitle2Docs>
                </li>
                ...
                <li>
                    Idiomas:
                    <br />
                    <Subtitle2Docs>Deve ser utilizado o i18Next em todos os textos que podem ter alteração de idioma.</Subtitle2Docs>
                </li>
            </ListDocs>
        </>
    );
