    ...
    return (
        <>
            ...
            <ListDocs>
                ...
                <li>
                    O arquivo <StrongDocs>app.json</StrongDocs> é onde estão os textos específicos do app, como por exemplo botões, menu, mensagens de
                    erro. O arquivo <StrongDocs>glossary.json</StrongDocs> é onde estão os textos em comum, como por exemplo qualquer palavra que pode
                    estar, ou não, no meio de qualquer texto.
                </li>
            </ListDocs>
            ...
            <ListDocs>
                ...
                <li>
                    As palavras devem começar com letra <StrongDocs>minúscula (exceto nome prórpio)</StrongDocs> e não devem terminar com caracteres
                    como {`".", "?", etc…`}, esses caracteres devem ser incluídos separados no código. Se for necessário começar com a letra
                    maiúscula, basta usar a função <StrongDocs>capitalizeFirstLetter</StrongDocs> ou o componente <StrongDocs>P</StrongDocs>, ou os
                    componentes de <StrongDocs>título</StrongDocs>. Ex:
    ...
    graphqlVariables: { locale: [i18n.language], where: { slug: productSlug } } 14 });`}
            ...
            <ListDocs>
                ...
                <li>
                    ...
                    <a href="https://blog.logrocket.com/complete-guide-internationalization-nextjs/" rel="noopener noreferrer" target="_blank">
                        (link2)
                    </a>
                </li>
            </ListDocs>
