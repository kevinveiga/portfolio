...
function NextJSWithHooks(): ReactElement {
    return (
        <>
            ...
            <ListDocs>
                <li>
                    Ao utilizar qualquer coisa que dependa do navegador, ex: window.localStorage, <StrongDocs>SEMPRE</StrongDocs> usar as
                    verificações. Ex:
                </li>
            </ListDocs>
  ...
  window.localStorage.removeItem(storageName);
            ...
            <ListDocs>
                <li>
                    ...
                    são utilizadas estratégias diferentes para trabalhar com dados, é <StrongDocs>IMPORTANTE</StrongDocs> saber usar corretamente cada
                    uma delas, veja a explicação{' '}
                    <a
                    ...
                    <SpacerDocs />
                    <P>
                        <StrongDocs>(SSG) getStaticProps:</StrongDocs> Para gerar páginas estáticas em rotas sem parâmetros. Obs: Deve ser usado o
                        revalidate para atualizar os dados.
                    </P>
                    <P>
                        <StrongDocs>(SSG | ISR) getStaticPaths:</StrongDocs> Para gerar páginas estáticas em rotas dinâmicas com parâmetros, é
                        utilizado junto com getStaticProps. Para usar ISR, o fallback deve ser true. Obs: Deve ser usado o revalidate para atualizar
                        os dados.
                    </P>
                    <P>
            ...
            <ListDocs>
                <li>
                    ...
                    é usado para dividir o código JavaScript, melhorando a performance, também é bem útil para evitar problemas de componentes que não
                    devem ser renderizados no lado do servidor (<StrongDocs>SSR</StrongDocs>). Um cenário onde é adequada a utilização, é em condições
                    de exibição ou não de componentes. Ex:
                </li>
            </ListDocs>
    ...
    type={stateModalMessage?.type} zIndex={15} {...stateModalMessage} />
            ...
            <ListDocs>
                ...
                <li>
                    ...
                    <a href="https://www.youtube.com/watch?v=aSXwLUSbwf4&ab_channel=DanielBerg" rel="noopener noreferrer" target="_blank">
                        (vídeo)
                    </a>
                </li>
                ...
                <li>
                    Route.{' '}
                    <a href="https://www.freecodecamp.org/news/routing-in-nextjs-beginners-guide/" rel="noopener noreferrer" target="_blank">
                        (link)
                    </a>
                </li>
