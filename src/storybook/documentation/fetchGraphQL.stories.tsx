...
function FetchGraphQLWithHooks(): ReactElement {
    return (
        <>
            ...
            <ListDocs>
                ...
                <li>
                    No arquivo .env existem duas variáveis de ambiente: <StrongDocs>HYGRAPH_MUTATION_TOKEN</StrongDocs> (para os posts no Hygraph) e{' '}
                    <StrongDocs>NEXT_PUBLIC_HYGRAPH_URL</StrongDocs> (para os gets do Hygraph).
                </li>
            </ListDocs>
  ...
  query Product($locale: [Locale!]! = [en], $where: ProductWhereUniqueInput!) {
    product(locales: $locale, where: $where) {...`}
            ...
            <ListDocs>
                <li>
                    O nome da variável de uma Mutation deve seguir o mesmo nome do objeto no Hygraph, assim como sua função, porém, o nome da mutation
                    deve ser na nomenclatura UpperCamelCase. Ex:
                </li>
            </ListDocs>
