...
function FormWithHooks(): ReactElement {
    return (
        <>
            ...
            <ListDocs>
                <li>
                    Se a estrutura dos campos estiver utilizando o componente <StrongDocs>Flex</StrongDocs>, então a configuração do Flex deve ter
                    obrigatoriamente o flex shrink com o valor 1. Ex:
            ...
            <ListDocs>
                <li>
                    Os campos que precisam de formatação no <StrongDocs>POST</StrongDocs> ou no <StrongDocs>GET</StrongDocs>, devem ter seu nome
                    incluído na função <StrongDocs>formDataFormatter</StrongDocs>. Ex:
                </li>
            </ListDocs>
...
...
            ...
            <ListDocs>
                ...
                <li>A variável validationSchema é usada para validação nos componentes do formulário e no submit do formulário. Ex:</li>
            </ListDocs>
