    ...
    return (
        <>
            ...
            <ListDocs>
                ...
                <li>
                    Não usar React.FC.{' '}
                    <a href="https://fettblog.eu/typescript-react-why-i-dont-use-react-fc/" rel="noopener noreferrer" target="_blank">
                        (link)
                    </a>
                </li>
...
\`;`}
            ...
            <ListDocs>
                ...
                <li>
                    Melhores práticas.{' '}
                    <a href="https://javascript.plainenglish.io/clean-code-in-typescript-a183d43f3bf0" rel="noopener noreferrer" target="_blank">
                        (link)
                    </a>
                </li>
                ...
                <li>
                    Declaration file.{' '}
                    <a href="https://basarat.gitbook.io/typescript/type-system/intro/d.ts" rel="noopener noreferrer" target="_blank">
                        (link)
                    </a>
                </li>
                ...
                <li>
                    UseState.{' '}
                    <a href="https://medium.com/ableneo/typing-of-react-hooks-in-typescript-947b200fa0b0" rel="noopener noreferrer" target="_blank">
                        (link)
                    </a>
                </li>
