        ...
        <>
            ...
            <ListDocs>
                ...
                <li>
                    ...
                    <Subtitle2Docs>
                        ...
                        <br />- <StrongDocs>Pages:</StrongDocs> Para usar páginas personalizadas de autenticação, pois o NextAuth cria suas próprias
                        páginas.
            ...
            <ListDocs>
                <li>
                    ...
                    {`"src/helpers/redirect.ts"`}, nessa função usar o valor que vem de <StrongDocs>router.query</StrongDocs> do useRouter. Ex:
                </li>
            </ListDocs>
...
const handleSubmit = (formData: any): void => {
    ...
    submit().catch(() => null);
            ...
            <ListDocs>
                ...
                <li>
                    NextAuth - Config.{' '}
                    <a href="https://next-auth.js.org/configuration/providers/credentials" rel="noopener noreferrer" target="_blank">
                        (link)
                    </a>
                </li>
