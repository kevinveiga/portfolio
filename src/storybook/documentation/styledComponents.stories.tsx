...
\`;`}
            ...
            <ListDocs>
                <li>
                    Quando se deseja definir um valor default de uma propriedade que já está sendo usada pelo Styled System, colocar undefined no
                    final da condição. Ex:
                </li>
            </ListDocs>
...
\`;`}
            ...
            <ListDocs>
                ...
                <li>
                    ...
                    <a href="https://blog.getty.io/desenvolvendo-apps-com-styled-components-85ec6880b194" rel="noopener noreferrer" target="_blank">
                        (link)
                    </a>
                </li>
