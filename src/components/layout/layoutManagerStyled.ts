...
export const LayoutManagerLeftCreateStyled = styled.div<IActiveStyled>`
    padding: ${variable.space.spacingXXS} ${({ change }): string => (change ? variable.space.spacingXS : variable.space.spacingXXS)};
    ...
    > button {
        ...
        height: 42px;
        overflow: hidden;
        padding: ${variable.layout.buttonPaddingY} ${({ change }): string => (change ? variable.space.spacingSM : variable.layout.buttonPaddingX)};
