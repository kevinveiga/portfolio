...
import dataVideosStreaming from '@/public/json/videos-streaming.json';
...
export function ManagerVideosStreaming(): ReactElement {
    // CONTEXT
        ...
        <LayoutManagerBoxStyled>
            <Flex flex="1 1 auto" flexDirection="column" py={5}>
                <Box flex="1 1 auto" px={4}>
                    <Title2 height="38px">{`${t('videos', { ns: 'glossary' })} / ${t('streaming', { ns: 'glossary' })}`}</Title2>
                </Box>
                ...
                <Wrap display="flex" position="absolute" px={4} right="100px" zIndex={2}>
                    <ManagerFilter
                        ...
                        id="videos-streaming"
                        ref={formRef}
                        searchPlaceholder={`${t('search for', { ns: 'glossary' })} ${t('videos', { ns: 'glossary' })}...`}
                    />
                </Wrap>
                ...
                <Box flex="1 1 auto">
                    <CarouselManagerDynamic data={dataVideosStreaming?.data} title="video" url="videos" />
                </Box>
            </Flex>
        </LayoutManagerBoxStyled>
    );
