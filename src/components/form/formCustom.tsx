...
import { arrayResolution } from '@/components/form/selectOption';
import {
    SvgArrowDown,
    SvgEmail,
    SvgIdentification,
...
export function InputCep({
    ...
    return (
        <InputContainerStyled>
            {showSvg ? <SvgPin height="16px" left={variable.layout.inputPaddingX} fill={bgColor.quaternary} maxWidth="16px" /> : null}
            ...
            {(error && !stateIsTouched) || stateHasError ? <ValidatedMessageStyled>{error || stateHasError}</ValidatedMessageStyled> : undefined}
        </InputContainerStyled>
    );
}
...
export function InputCpf({
    ...
    return (
        <InputContainerStyled>
            {showSvg ? <SvgIdentification height="16px" left={variable.layout.inputPaddingX} fill={bgColor.quaternary} maxWidth="16px" /> : null}
...
export function InputCurrency({
    ...
    return (
        <InputContainerStyled>
            {showSvg ? <SvgMoney height="16px" left={variable.layout.inputPaddingX} fill={bgColor.quaternary} maxWidth="16px" /> : null}
...
export function InputEmail({
    ...
    return (
        <InputContainerStyled>
            {showSvg ? <SvgEmail height="16px" left={variable.layout.inputPaddingX} fill={bgColor.quaternary} maxWidth="16px" /> : null}
...
export function InputName({
    ...
    return (
        <InputContainerStyled>
            {showSvg ? <SvgUser height="16px" left={variable.layout.inputPaddingX} fill={bgColor.quaternary} maxWidth="16px" /> : null}
...
export function InputNumber({
    ...
    return (
        <InputContainerStyled>
            {showSvg ? <SvgNumber height="16px" left={variable.layout.inputPaddingX} fill={bgColor.quaternary} maxWidth="16px" /> : null}
...
export function InputPassword({
    ...
    return (
        <InputContainerStyled>
            {showSvg ? <SvgLock height="16px" left={variable.layout.inputPaddingX} fill={bgColor.quaternary} maxWidth="16px" /> : null}
...
export function InputPhone({
    ...
    return (
        <InputContainerStyled>
            {showSvg ? <SvgPhone height="16px" left={variable.layout.inputPaddingX} fill={bgColor.quaternary} maxWidth="16px" /> : null}
...
export function SelectCustom({
    ...
    return (
        <InputContainerStyled>
            ...
            {SvgComponent ? <SvgComponent height="16px" left={variable.layout.inputPaddingX} fill={bgColor.quaternary} maxWidth="16px" /> : null}
...
export function SelectResolution({
    ...
    // VALIDATE
    const validationSchemaCustomResolution = yup.object().shape({
        [`${fieldName}-custom-horizontal`]: yup.number().min(360).max(3840),
        [`${fieldName}-custom-vertical`]: yup.number().min(360).max(3840)
    });
    ...
    return (
        <>
            <InputContainerStyled>
                ...
                <SelectOptionsCustomStyled active={stateSelect} ref={selectOptionsRef} {...props}>
                    <ul>
                        {arrayResolution?.length > 0 ? (
                            <>
                                {arrayResolution?.map((item: ISelectCustomItems) => {
                                    return (
                                        <li key={item.value}>
                                            <Button
                                                onClick={(): void => handleChange(item.label, item.value)}
                                ...
                                <li>
                                    <Button
                                        onClick={(): void => handleChange(t('custom', { ns: 'glossary' }), 'custom')}
                                        text={capitalizeFirstLetter(t('custom', { ns: 'glossary' }))}
                                        typeStyle="button-unset"
                                    />
                                </li>
                            </>
            ...
            {stateCustom ? (
                <Flex columnGap={variable.space.spacingXS} zIndex={-1}>
                    <Box>
                        <InputNumber
                            height="32px"
                            idInput={`${idInput}-custom-horizontal`}
                            max={3840}
                            name={`${fieldName}-custom-horizontal`}
                            showSvg={false}
                            textAlign="center"
                            validationSchema={validationSchemaCustomResolution}
                            width="100px"
                        />
                    </Box>

                    <Box alignItems="center">x</Box>

                    <Box>
                        <InputNumber
                            height="32px"
                            idInput={`${idInput}-custom-vertical`}
                            max={3840}
                            name={`${fieldName}-custom-vertical`}
                            showSvg={false}
                            textAlign="center"
                            validationSchema={validationSchemaCustomResolution}
                            width="100px"
