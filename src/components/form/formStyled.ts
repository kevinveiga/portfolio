...
const input = css<IInputStyled>`
    ...
    ${({ pb }): string | undefined => (pb === undefined ? `padding-bottom: ${variable.layout.inputPaddingY}` : undefined)};
...
export const InputStyled = styled.input.attrs<IInputStyled>(({ invalid }) => {
    ...
    ${({ invalid, validation }): string | undefined => (invalid && validation ? `border: 1px solid ${variable.color.alert}` : undefined)};
    ${({ valid, validation }): string | undefined => (valid && validation ? `border: 1px solid ${variable.color.primary}` : undefined)};
`;
...
export const LabelStyled = styled.label<ITextStyled>`
    ...
    ${({ py }): string | undefined =>
        py === undefined ? `padding-bottom: ${variable.space.spacingXS}; padding-top: ${variable.space.spacingXS}` : undefined};
    z-index: 1;
...
export const SelectStyled = styled.select.attrs<IInputStyled>(({ invalid }) => {
    ...
    ${({ invalid, validation }): string | undefined => (invalid && validation ? `border: 1px solid ${variable.color.alert}` : undefined)};
    ${({ valid, validation }): string | undefined => (valid && validation ? `border: 1px solid ${variable.color.success}` : undefined)};
`;
