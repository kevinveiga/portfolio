...
export const main = css<ILayoutStyled>`
    ...
    height: auto;
    ${({ maxWidth }): string | undefined => (maxWidth === undefined ? `max-width: ${variable.breakpoint.lg}` : undefined)};
...
export const Container = styled.div<ILayoutStyled>`
    ...
    ${({ px }): string | undefined =>
        px === undefined ? `padding-left: ${variable.space.spacingXS}; padding-right: ${variable.space.spacingXS}` : undefined};
    ${({ py }): string | undefined =>
    ...
    @media (min-width: ${variable.breakpoint.md}) {
        ${({ px }): string | undefined =>
            px === undefined ? `padding-left: ${variable.space.spacingMD}; padding-right: ${variable.space.spacingMD}` : undefined};
        ${({ py }): string | undefined =>
            py === undefined ? `padding-bottom: ${variable.space.spacingMD}; padding-top: ${variable.space.spacingMD}` : undefined};
    }
`;
...
export const Spacer = styled.div<IStyledSystem>`
    ...
    ${({ height }): number | string | undefined => (height === undefined ? `height: ${variable.space.spacingSM}` : undefined)};
    ${({ width }): number | string | undefined => (width === undefined ? `width: ${variable.space.spacingSM}` : undefined)};
`;
