...
export const gradientDirection3Colors = ({
    ...
    return css`
        background-image: linear-gradient(${deg}, ${colorStart} ${colorStartPercent}, ${colorMid} ${colorMidPercent}, ${colorEnd} ${colorEndPercent});
        background-repeat: repeat-x;
    `;
};
...
export const gradientDirectionRepeat = ({
    ...
    return css`
        background-image: repeating-linear-gradient(${deg}, ${colorStart} ${colorStartPercent}, ${colorEnd} ${colorEndPercent});
    `;
};
...
export const gradientRadialRepeat = ({
    ...
    return css`
        background-image: repeating-radial-gradient(circle, ${colorStart} ${colorStartPercent}, ${colorEnd} ${colorEndPercent});
    `;
};
...
export const scrollbar = (colorPrimary = variable.color.primary, colorSecondary = variable.color.grayDark2, scrollbarSize = '8px'): any => {
    return css`
        &::-webkit-scrollbar {
...
export const scrollbarTable = (colorPrimary = variable.color.gray, colorSecondary = variable.color.grayDark3, scrollbarSize = '6px'): any => {
    return css`
        &::-webkit-scrollbar {
            height: ${scrollbarSize};
