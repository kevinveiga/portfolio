...
export const SpacerDocs = styled.div<IStyledSystem>`
    ...
    ${({ height }): number | string | undefined => (height === undefined ? `height: ${variable.space.spacingMD}` : undefined)};
...
export const Title2Docs = styled.h2<ITextStyled>`
    ...
    ${({ fontWeight }): string | undefined => (fontWeight === undefined ? 'font-weight: 700' : undefined)};
    ${({ my }): string | undefined => (my === undefined ? `margin: ${variable.space.spacingSM} 0 ${variable.space.spacingXS} 0` : undefined)};
